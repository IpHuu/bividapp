...
class DeNghiMuaVppItem extends StatelessWidget {
  const DeNghiMuaVppItem(
      {Key? key, required this.deNghiMuaVpp, this.showAction = true})
      : super(key: key);
  final DeNghiMuaVpp deNghiMuaVpp;
  final bool showAction;

  @override
  Widget build(BuildContext context) {
    return _buildDeNghiMuaVppItem(context: context, item: deNghiMuaVpp);
  }

  Widget _buildDeNghiMuaVppItem(
      {required BuildContext context, required DeNghiMuaVpp item}) {
    ...
    return GestureDetector(
      onTap: () {
        MyNavigation.intentWithData(
          ScreenRouteName.previewDeNghiMuaVppPage,
