...
class MenuDeNghiCapVpp extends StatefulWidget {
  final DeNghiCapVppArgs args;
  final Future<bool> Function(bool isApproved, DeNghiCapVppArgs data)
      onApproved;

  final BuildContext? parentContext;
  const MenuDeNghiCapVpp(
      {Key? key,
      required this.args,
  ...
  @override
  State<MenuDeNghiCapVpp> createState() => _MenuDeNghiCapVppState();
}

class _MenuDeNghiCapVppState extends State<MenuDeNghiCapVpp> {
  ...
  Future<void> doApprove(bool approved, String noiDung) async {
    ...
    widget.args.documentId = widget.args.idDeNghi;
    ...
    try {
      ...
      if (isOk) {
        ...
        mainModel.giayDeNghiCapVppStream.add(widget.args.idDeNghi!);
        mainModel.documentChartStream.add(widget.args.idDeNghi!);
      } else {
