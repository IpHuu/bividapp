...
class MenuChiPhiCongTac extends StatefulWidget {
  final ChiPhiCongTacArgs args;
  final Future<bool> Function(bool isApproved, ChiPhiCongTacArgs data)
      onApproved;

  final BuildContext? parentContext;
  const MenuChiPhiCongTac(
      {Key? key,
      required this.args,
  ...
  @override
  State<MenuChiPhiCongTac> createState() => _MenuChiPhiCongTacState();
}

class _MenuChiPhiCongTacState extends State<MenuChiPhiCongTac> {
  late final String _cancelText = 'Trả lại';
  late final String _okText = 'Xác nhận';
    ...
    try {
      ...
      if (isOk) {
        await Future.sync(() {
          ...
          mainModel.giayChiPhiCongTacStream.add(widget.args.idGiayXinPhep!);
