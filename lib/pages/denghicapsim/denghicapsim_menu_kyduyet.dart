...
class MenuDeNghiCapSim extends StatefulWidget {
  final DeNghiCapSimArgs args;
  final Future<bool> Function(bool isApproved, DeNghiCapSimArgs data)
      onApproved;

  final BuildContext? parentContext;
  const MenuDeNghiCapSim(
      {Key? key,
      required this.args,
  ...
  @override
  State<MenuDeNghiCapSim> createState() => _MenuDeNghiCapSimState();
}

class _MenuDeNghiCapSimState extends State<MenuDeNghiCapSim> {
  ...
  Future<void> doApprove(bool approved, String noiDung) async {
    ...
    try {
      if (isOk) {
        ...
        mainModel.giayDNCapSimStream.add(widget.args.idDeNghi!);
