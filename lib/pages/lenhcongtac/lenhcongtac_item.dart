...
class LenhCongTacItem extends StatelessWidget {
  const LenhCongTacItem(
      {Key? key, required this.lenhCongTac, this.showAction = true})
      : super(key: key);
  final LenhCongTac lenhCongTac;
  final bool showAction;

  @override
  Widget build(BuildContext context) {
    return _builLenhCongTacItem(context: context, item: lenhCongTac);
  }

  Widget _builLenhCongTacItem(
      {required BuildContext context, required LenhCongTac item}) {
    ...
    return GestureDetector(
      onTap: () {
        MyNavigation.intentWithData(
          ScreenRouteName.previewLenhCongTacPage,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Từ ngày: $tuNgayText, đến ngày: $denNgayText",
                                style: const TextStyle(
                                    color: UIHelper.BIVID_BLACK_TEXT_COLOR,
                                    fontSize: 10,
