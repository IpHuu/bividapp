...
class MenuLenhCongTac extends StatefulWidget {
  final LenhCongTacArgs args;
  final Future<bool> Function(bool isApproved, LenhCongTacArgs data) onApproved;

  final BuildContext? parentContext;
  const MenuLenhCongTac(
      {Key? key,
      required this.args,
  ...
  @override
  State<MenuLenhCongTac> createState() => _MenuLenhCongTacState();
}

class _MenuLenhCongTacState extends State<MenuLenhCongTac> {
  ...
  Future<void> doApprove(bool approved, String noiDung) async {
    ...
    try {
      ...
      if (isOk) {
        ...
        mainModel.giayLenhCongTacStream.add(widget.args.idGiayXinPhep!);
