...
class MenuPhieuDeXuatMuaHang extends StatefulWidget {
  final PhieuDeXuatMuaHangArgs args;
  final Future<bool> Function(bool isApproved, PhieuDeXuatMuaHangArgs data)
      onApproved;

  final BuildContext? parentContext;
  const MenuPhieuDeXuatMuaHang(
      {Key? key,
      required this.args,
  ...
  @override
  State<MenuPhieuDeXuatMuaHang> createState() => _MenuPhieuDeXuatMuaHangState();
}

class _MenuPhieuDeXuatMuaHangState extends State<MenuPhieuDeXuatMuaHang> {
  ...
  Future<void> doApprove(bool approved, String noiDung) async {
    ...
    try {
      ...
      if (isOk) {
        ...
        mainModel.giayDXMHStream.add(widget.args.idDeXuatMh!);
        mainModel.documentChartStream.add(widget.args.idDeXuatMh!);
      } else {
