...
abstract class $ErrorResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'validationErrors') List<String>? validationErrors});
}
...
class _$ErrorResponseImpl implements _ErrorResponse {
  ...
  @override
  String toString() {
    return 'ErrorResponse(status: $status, message: $message, validationErrors: $validationErrors)';
  }
...
abstract class _ErrorResponse implements ErrorResponse {
  factory _ErrorResponse(
      ...
      @JsonKey(name: 'validationErrors')
      final List<String>? validationErrors}) = _$ErrorResponseImpl;
