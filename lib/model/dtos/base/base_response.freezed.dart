...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$BaseResponseCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
abstract class Success<T> implements BaseResponse<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$BaseResponseCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'BaseResponse<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements BaseResponse<T> {
